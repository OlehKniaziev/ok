...
TEST_FILES = tests/arena.test.o tests/string-view.test.o tests/string.test.o tests/fixed-buffer-allocator.test.o tests/to-string.test.o tests/list.test.o tests/hash.test.o
